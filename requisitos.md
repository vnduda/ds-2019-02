...
### Requisitos (preliminares):
  ...
  - R2 A expressão matemática está restrita a valores numéricos (ou tipo _Double_ em Java). 
  - R3 A expressão matemática recebida como entrada deve ser convertida para _bytecodes_ por meio do uso da biblioteca [Javassist](https://www.javassist.org/). Observação: embora seja uma decisão típica de _design_, esta é uma restrição imposta ao desenvolvimento do módulo.
